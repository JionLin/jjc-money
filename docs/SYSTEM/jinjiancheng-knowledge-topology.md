# 金渐成知识图谱目录 — 全局拓扑扫描 (2022.11 → 2026.04)

> **扫描范围**：`22-25year/` 30个月度文件 + `26year/` 2026-01/02/03/04 月度文件 + `Global Market Outlook for 2026.md`  
> **总文章数**：约 **340+ 篇**（含评论区互动）  
...
- **伯克希尔防守引擎**（2026-04 起的重要补丁）
- **个人组合四层校准**（用户约束 / 持仓快照 / 策略意图 / 行动翻译）
...
- 通胀 / CPI / 非农数据解读
- 关税 / 贸易战 / 中美脱钩
- **2026 年全球市场路线图**（铜铝 / 日本 / 英国富时 / 港股 / BTC）
- **日历风险叠加**（4月报税期 / 9月季度纳税期 / 6月初到9月初高波动窗口）
- 中国降息降准 / 财政政策
...
## 1.1 2026-04 / 年度路线增量补丁

和 `2026-03` 以前相比，2026 年 4 月这轮补充最重要的不是“多了几个点位”，而是多了一层新的**执行框架**：

1. **战术 / 年度时框分离**
   - `26year/2026-04.md` 主要提供战术动作、仓位漂移、评论区补充、作者当下语气
   - `Global Market Outlook for 2026.md` 主要提供年度路线、跨资产优先级、年度支撑/目标区间
2. **防守层升级**
   - `BRK` 从防守外围走向防守中层骨架
   - 部分 `BIL` 现金管理仓位，开始切向 `BRK`
3. **全球观察池扩容**
   - 工业金属：铜 > 铝
...
4. **日历风险显性化**
   - 4 月中旬报税期
   - 9 月季度纳税期
   - 6 月初到 9 月初若叠加降息落空或中期选举扰动，波动率提升
5. **加密定位更清楚**
   - `BTC` 只做条件式参与
   - 年度防守线：`5.6万 / 5万 / 4.5万`

这意味着作者的认知角色，也从“美股实战投资者”进一步过渡到“更低频、更重防守、带全球路由意识的配置者”。
