...
### 论点 3b：「现金像氧气」
> *"现金像氧气，关键时刻能救命。"* — 2026-04
> *"现金流不是摆设，是未来抄底优质资产的权利。"* — 2026 语境层总结

- 现金不是闲置，而是未来接货、换仓、防黑天鹅的权利
- 作者到 2026 年后，更强调“保留选择权”而不是“把仓位打满”
...
> 这是 2026 年后新增的执行层补丁，解决“同样一个框架，为什么不同人不能直接照抄”的问题。
...
4. **行动翻译**
   - 转成金额、股数、买卖带
   - 用 `2-3-3-2`、金字塔、分档减仓去表达

补充纪律：
- 如果个人快照超过 14 天，默认视为可能过期
- 如果用户新输入和旧卡片/旧计划冲突，永远以最新输入为准
- 不要把个人交易卡片写死成永久事实
...
| 2026-04初 | ~40% | ~17% | ~43-46% | 防守被动上升（科技股下跌） |
| 2026-04中 | ~44.5% | ~15%+ | ~40%+ | 科技股修复后进取占比回升 |

> *"过去几年，资金超85成押在美股七巨头为主的科技股上，也因此收益丰厚。"* — 2026-01
> *"我前期是进取型，目前整体是稳健型，已经在往防守型的方向过渡。"* — 2026-01
> *"稳健型，因为进取型的占比还是比较大的，4成，防守型只有4成多。如果是防守型，那防守型会达到8成，我还没进入那个阶段。"* — 2026-04

### 3.1 2026-04 防守引擎补丁

> 到了 2026-04，作者对防守层的理解又往前走了一步：
> 防守不再只是“拿一堆短债和高股息”，而是形成了 **美债压仓 + 伯克希尔中层骨架 + 外围高股息** 的结构。

核心变化有三点：

1. `BRK` 从“防守外围”逐步升级为“防守中层骨架”
2. 原本偏现金管理的部分 `BIL` 仓位，开始逐步切向 `BRK`
3. 防守层的作用不只是抗波动，还要在机会出现时提供新的现金流和再配置能力

这层升级背后的语境是：
- 钱越大，动作越慢
- 税越重，越少乱动
- 防守型资产要能让人“拿得住、睡得着、关键时刻有子弹”

可以把 2026-04 的结构理解成：

```text
内层：美债 / 美债ETF ~65%（压仓、防黑天鹅）
中层：伯克希尔 13.5%→目标 30%（防守引擎、间接抄底能力）
外层：KO / JNJ / SCHD / VISA ~21%（股息与稳定现金流）
```

> *"伯克希尔主要是用于防守，拿着三年不涨，我都不在乎。"* — 2026-04
> *"市场出现机会时，由它来负责把握，毕竟它这个组合体很适合做防守：保险+公用事业能源+铁路+制造/零售/服务+巨额投资组合+$3730亿天量现金。"* — 2026-04
...
到 2026 年，作者的默认视角已经不是“高频进攻的小资金模式”，而是：

- 更低频
- 更重防守
- 更在意税务与持有周期
- 更重视账户隔离、现金流、和是否有必要用质押替代卖出

这意味着很多旧文章里看上去很激进的动作，放到新阶段里，都要先经过“资金体量 / 税负 / 流动性 / 持有目的”再解释一遍。

### 3.3 加州税务约束（2026-04 新增）

> [!IMPORTANT]
> 作者移居加州后，税务成本成为操作风格的重大约束条件。
...
**操作风格调整**：
1. **长期持有 + 质押替代卖出**：*"控制低成本/负成本，长期持有。需要大体量的资金，再质押股票获取资金就行，这样就没有税了。"*
2. **留小账户操作着玩**：$370万小账户保持操作节奏
3. **减少交易频率**：从中高频降为低频

### 3.4 策略有效期 — 反刻舟求剑

> [!WARNING]
> 作者明确指出：**任何策略都有保质期，通常 2-3 年就会过期。**

> *"做 AI 笔，顶多用 2-3 年，就过期了。指望用一个策略一直盈利下去，和刻舟求剑没什么两样。"* — 2026-04
> *"成功的交易员，不是赚得最多，是市场转向的时候还能活下来。"* — 2026-04

核心含义：
- 2 年前的策略和节点，不能原封不动照搬
- 策略必须跟随市场变化、个人体量变化、风险承受力变化而迭代
- "活下来"比"赚最多"更重要
...
### 6.6 支撑位挂单差价教训（2026-04 MSFT）
> MSFT 设置 $355 加仓节点，实际最低价 $356.26，仅差 **$1.26** 未触发。
> 教训：“大概比精准重要”，挂单可适当放宽 1-2%，避免因微小差价错过整个加仓机会。
> 作者实际操作：在 $357 临时加仓，仓位升至 15.6%。
...
| *"成功的交易员，不是赚得最多，是市场转向的时候还能活下来。"* | 风控第一、生存优先 |
| *"做 AI 笔，顶多用2-3年就过期了。"* | 策略迭代、反刻舟求剑 |
